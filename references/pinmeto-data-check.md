...
| 1,000+ | 10 per report | **Scope required in practice**: one report per country/region (each with its own 5/10 sample and Site or artifact). A single global report is allowed but must state how thin 10-of-N coverage is |
