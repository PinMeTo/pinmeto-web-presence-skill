...
2. Tag and push: `git tag v0.7.0 && git push --tags`.
...
```json
{
  "skills": {
    ...
    "pinmeto-web-presence":     { "repo": "PinMeTo/pinmeto-web-presence-skill",     "version": "0.7.0" }
  }
}
```
...
`v0.7.0` — four-pillar methodology on rubric 2.11.0-skill.1 (MLPR 2.8.0 + Bing re-added + PinMeTo-connection check); GEO evidence
